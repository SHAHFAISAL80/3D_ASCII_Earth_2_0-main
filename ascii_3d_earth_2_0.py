...
with open(r'E:\Games Projects\3D_ASCII_Earth_2_0-main\earth_2_0_W140_H35.txt', 'r') as file:
...
with open(r'E:\Games Projects\3D_ASCII_Earth_2_0-main\moon_W50_H16.txt', 'r') as file:
    data = [file.read().replace('\n', '')]
